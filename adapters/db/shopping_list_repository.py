...
class SQLiteShoppingListRepository(ShoppingListRepository):
    ...
    def _create_shopping_list(self, shopping_list: ShoppingList, thread_id: str) -> ShoppingList:
    ...
    def _update_shopping_list(self, shopping_list: ShoppingList, thread_id: str) -> ShoppingList:
