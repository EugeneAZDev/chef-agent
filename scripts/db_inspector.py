...
# from adapters.db.database import Database  # Unused import
...
def run_sample_queries(db_path: str = "chef_agent.db"):
    ...
    for recipe in recipes:
        print(
            f"  ID: {recipe['id']}, Title: {recipe['title']}, "
    ...
    for list_item in lists:
        ...
        print(
            f"  Thread: {list_item['thread_id']}, Items: {len(items)}, "
            f"Created: {list_item['created_at']}"
        )
